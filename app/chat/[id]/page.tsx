...
const ChatPage: React.FC<ChatProps> = ({ params }) => {
  const { id } = params
  ...
  const sendVideoMessage = useCallback(() => {
    ...
    const videoMessage: Message = {
      ...
      sender: "them",
      isVideo: true,
      videoUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/video%2001-comprimido-8YsSHpEywxkSEz3F2mIcNBNIkcs1ow.mp4",

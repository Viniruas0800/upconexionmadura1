...
export default function RegistrationPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isValid) {
      ...
      // Create the destination URL with the form action
      let destinationUrl = "/profile-setup"

      // Add any URL parameters from the current page
      if (urlParams.toString()) {
        destinationUrl += (destinationUrl.includes("?") ? "&" : "?") + urlParams.toString()
      }
